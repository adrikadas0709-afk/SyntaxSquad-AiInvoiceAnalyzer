...
export default function App() {
  ...
  useEffect(() => {
    ...
    window.addEventListener("popstate", logoutOnLeave);
    document.addEventListener("visibilitychange", logoutOnHidden);

    return () => {
      window.removeEventListener("pagehide", logoutOnLeave);
      window.removeEventListener("beforeunload", logoutOnLeave);
      window.removeEventListener("popstate", logoutOnLeave);
      document.removeEventListener("visibilitychange", logoutOnHidden);
    };
  }, [clearSessionData]);
